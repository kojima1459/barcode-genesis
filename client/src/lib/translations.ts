...
export const translations = {
  ja: {
    ...
    // Home Guide
    guide_card_title: "あそびかた ガイド",
    guide_card_desc: "このゲームの ルールを みる",
    guide_badge: "GUIDE",
    ...
    // How To Play
    how_to_title: "あそびかた ガイド",
    how_to_steps_title: "3ステップで かんたん スタート！",
    how_to_summary: "ルールをよむ → スキャン → バトル！",
    how_to_welcome: "バーコードをスキャンして、キミだけの ロボットを みつけよう！",
    step_rule: "ルール",
    step_scan: "スキャン",
    step_battle: "バトル",
    step_workshop: "こうぼう",
    howto_step1_title: "STEP 1: スキャンして ロボットをつくろう！",
    howto_step1_desc: "おうちにある おかしや ノートの バーコードを カメラで よみこんでね。13ケタの すうじから、キミだけの ロボットが かんせいするよ！",
    howto_step1_note1: "なまえや つよさは バーコードで きまるよ！",
    howto_step1_note2: "レアな ロボットを さがしてみよう！",
    howto_step2_title: "STEP 2: バトルで つよくなる！",
    howto_step2_desc: "つくった ロボットで バトルしよう！ かったら XP（けいけんち）が もらえるよ。",
    howto_step2_note1: "まけても すこし もらえるから あんしん！",
    howto_step2_note2: "XPが たまると レベルアップして つよくなる！",
    howto_step3_title: "STEP 3: いろんな ロボットを あつめよう！",
    howto_step3_desc: "たくさんの ロボットを あつめて ずかん（ユニット）を コンプリートしよう！",
    howto_step3_note1: "「クラフト」で かっこいい 色にかえられるよ！",
    howto_step3_note2: "「ユニット」で あつめた ロボットを みよう！",
    faq_title: "よくあるしつもん",
    faq_q1: "Q. 読みこめないバーコードがある？",
    faq_a1: "A. 13ケタの JANコード（ジャンコード）なら だいじょうぶ。それいがいだと エラーになることがあるよ。",
    faq_q2: "Q. うまく読みこめないときは？",
    faq_a2: "A. あかるい ばしょで、光が はんしゃしないように うつしてね。",
    faq_q3: "Q. プレミアムプランってなに？",
    faq_a3: "A. 広告がきえたり、ロボットを たくさん もてるように なるよ。",
    premium_desc: "システムをアップグレードして、もっと たのしく あそぼう！",
    ...
    workshop_action_battle: "バトルでレベル上げ",
    workshop_action_scrap: "バリアントを整理",
    workshop_full_title: "製造ラインが満杯です",
    workshop_full_desc: "バリアントの保管上限に達しました。\nレベルを上げて上限を増やすか、不要な機体を廃棄してください。",
    ...
    scan_chip_gained: "チップを 1つ 手に入れたよ！",
    ...
    howto_enhance_title: "もっと つよくなるには？",
    howto_enhance_desc: "ロボットを パワーアップする ほうほうは 3つ！",
    howto_synthesis_title: "ごうせい（Synthesis）",
    howto_synthesis_desc: "いらない ロボットを そざいにして、レベルアップしよう！",
    howto_evolution_title: "しんか（Evolution）",
    howto_evolution_desc: "おなじ ロボットを 2たい がったいさせて、★ランクを あげよう！",
    howto_workshop_title: "こうぼう - バリアント (Workshop)",
    howto_workshop_desc: "2たいの ロボットを 組みあわせて、あたらしい 見た目の こうせいのう ロボットをつくる！",
    howto_enhance_tip: "💡 ヒント: レベルをあげると、もてる ロボットの かずが ふえるよ！",

    // HowTo: Level Up Methods
    howto_levelup_title: "レベルの あげかた",
    howto_levelup_desc: "レベルをあげて ロボットを さいきょうに しよう！",
    howto_battle_title: "たいせんバトル",
    howto_battle_xp: "かったら XPゲット！ まけても すこし もらえるよ。",
    howto_synthesis_xp: "ごうせいで、いっきに レベルアップ！",
    howto_training_title: "とっくん (Training)",
    howto_training_warn: "⚠️ とっくんは れんしゅう用だから、XPは もらえないよ。",
  ...
  en: {
    ...
    shop_insufficient_tokens: "Insufficient Chips",
    shop_invalid_recipe: "Invalid recipe",
    shop_insufficient_materials: "Insufficient materials or credits",
    shop_chip_hint: "💡 Get Chips from Scans and Boss Battles!",
    // Shop (New)
    ...
    scan_chip_gained: "Gained 1 Chip!",
