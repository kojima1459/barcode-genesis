          ...
          <div className="md:grid md:grid-cols-12 md:gap-6 space-y-5 md:space-y-0">
            ...
            <div className="md:col-span-4 space-y-4">
              ...
              <div className="grid grid-cols-1 gap-3">
                <Link href="/premium">
                  <div className="relative overflow-hidden rounded-xl border border-yellow-500/50 bg-black/40 backdrop-blur-sm group hover:border-yellow-400 transition-all cursor-pointer h-24 flex items-center px-6 shadow-[0_0_15px_rgba(234,179,8,0.2)]">
