...
import { Scan, Sword, Trophy, Zap, Cpu } from "lucide-react";
...
export default function TutorialModal() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-md bg-black/90 border border-white/10 text-white backdrop-blur-xl shadow-[0_0_50px_rgba(0,0,0,0.8)] p-0 overflow-hidden gap-0">
