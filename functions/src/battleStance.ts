...
import { RobotData, Stance, StanceOutcome } from "./types";
import { SeededRandom } from "./seededRandom";

// Stance weights derived deterministically from robot parts/barcode
 ...
 */
export const getStanceWeights = (robot: RobotData): StanceWeights => {
 ...
 */
export const pickStance = (rng: SeededRandom, weights: StanceWeights): Stance => {
    const roll = rng.next();
 ...
 */
export const resolveStance = (attacker: Stance, defender: Stance): StanceOutcome => {
 ...
 */
export const getStanceMultiplier = (outcome: StanceOutcome, isAttacker: boolean): number => {
    switch (outcome) {
        case "WIN":
 ...
 */
export const getStanceIcon = (stance: Stance): string => {
    switch (stance) {
