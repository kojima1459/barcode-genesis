...
exports.getPassiveEffect = exports.checkPassive = exports.getPassive = void 0;
// ============================================
 ...
 */
const getPassive = (partType, partId) => {
 ...
 */
const checkPassive = (rng, robot, partType) => {
    ...
    switch (partType) {
        case "weapon":
            ...
            break;
        case "backpack":
            partId = parts.backpack;
            break;
        case "accessory":
            partId = parts.accessory;
            break;
    }
    const passive = (0, exports.getPassive)(partType, partId);
    if (!passive)
        return null;
    // Roll for trigger
...
exports.checkPassive = checkPassive;
/**
 * Get the effect values for a triggered passive
 */
const getPassiveEffect = (trigger) => {
    const passive = (0, exports.getPassive)(trigger.partType, trigger.partId);
    if (!passive)
        return {};
    ...
    if (name === "Berserker")
        return { damageMultiplier: 1.4 };
    if (name === "Overcharge")
        return { damageMultiplier: 1.3 };
    if (name === "Heavy Swing")
        return { damageMultiplier: 1.2 };
    if (name === "Power Cell" || name === "Counterweight" || name === "Aggressor Chip")
        return { damageMultiplier: 1.15 };
    // Crit bonuses
    if (name === "Focus Lens")
        return { critBonus: 0.2 };
    if (name === "Sharpened Edge")
        return { critBonus: 0.15 };
    if (name === "Targeting System")
        return { critBonus: 0.12 };
    if (name === "Precision Strike")
        return { critBonus: 0.1 };
    if (name === "Lucky Charm")
        return { critBonus: 0.08 };
    if (name === "Lock-On")
        return { critBonus: 1.0 }; // Guaranteed crit
    // Defense penetration
    if (name === "Piercing Shot")
        return { defenseMultiplier: 0.5 };
    if (name === "Armor Break")
        return { defenseMultiplier: 0.7 };
    // Follow-up attacks
    if (name === "Dual Strike" || name === "Afterburner")
        return { followUpDamage: 0.35 };
    if (name === "Booster Ignition")
        return { followUpDamage: 0.25 };
    if (name === "Quick Slash")
        return { followUpDamage: 0.2 };
    if (name === "Thruster Boost")
        return { followUpDamage: 0.15 };
    // Damage reduction
    if (name === "Guardian Module")
        return { damageReduction: 0.7 };
    if (name === "Deflector")
        return { damageReduction: 0.75 };
    if (name === "Reinforced Armor" || name === "Smoke Screen")
        return { damageReduction: 0.8 };
    if (name === "Iron Plating" || name === "Energy Shield")
        return { damageReduction: 0.85 };
    // Life steal
    if (name === "Life Steal Core")
        return { healRatio: 0.15 };
    if (name === "Energy Drain")
        return { healRatio: 0.1 };
    // Heal
    if (name === "Emergency Repair")
        return { healRatio: 0.1 }; // Used differently in battle
    if (name === "Nano Repair")
        return { healRatio: 0.08 };
    return {};
};
exports.getPassiveEffect = getPassiveEffect;
//# sourceMappingURL=battlePassives.js.map